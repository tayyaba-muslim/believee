...
<div id="footer" class="foot"><!-- Footer -->
                      ...
                      <div class="row">
                          <div class="col-md-3">
                              <div class="text-widget">
                                  <div class="wid-title" ><center> Welcome to</center></div>
              ...
              <div class="footer-text">
                  <div class="container">
                      <p>Copyright 2018. Designed and Developed by <a href="https://bootstrapmart.com/">TTS </a> &amp; Distributed by <a href="https://themewagon.com/">TTS</a></p>
                  </div>
              </div>
          </div><!-- Footer -->
      </div> <!-- wrapper -->
